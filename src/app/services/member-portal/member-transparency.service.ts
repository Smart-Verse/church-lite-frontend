...
export class MemberTransparencyService {
  ...
  get(): Observable<TransparencyConfiguration> { return this.http.get<TransparencyConfiguration>('memberPortal/transparency'); }
  update(configuration: TransparencyConfiguration): Observable<TransparencyConfiguration> {
    return this.http.put<TransparencyConfiguration>('memberPortal/transparency', configuration);
  }
}
