...
export class PersonConfig {
  ...
  convertPersonToDTO(
    ...
    dto.personalDocs.birthDate = datePipe.transform(
      dto.personalDocs.birthDate,
      'yyyy-MM-dd',
    )!;
    dto.personMember.entryDate = datePipe.transform(
      dto.personMember.entryDate,
      'yyyy-MM-dd',
    )!;
    dto.personMember.dateBaptism = datePipe.transform(
      dto.personMember.dateBaptism,
      'yyyy-MM-dd',
    )!;
    return dto;
  }
